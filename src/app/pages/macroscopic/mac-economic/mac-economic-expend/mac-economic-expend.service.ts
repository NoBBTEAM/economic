...
export class MacEconomicExpendService {
  ...
  private subjectExpend = new BehaviorSubject<any>(0);
  private subjectExpendDetail = new BehaviorSubject<any>(0);
  constructor() {
    this.changeExpendData();
    this.changeExpendDetailData();
  }
  ...
  changeExpendData() {
    ...
    this.subjectExpend.next({
      expendOptions: expendOptions
    });
  }

  changeExpendDetailData() {
    const weatherIcons = {
    ...
    this.subjectExpendDetail.next({
      expendDetailOptions: expendDetailOptions
    });
  }

  getExpendData(): Observable<any> {
    return this.subjectExpend.asObservable();
  }

  getExpendDetailData(): Observable<any> {
    return this.subjectExpendDetail.asObservable();
  }
}
